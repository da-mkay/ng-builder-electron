...
-   <a href="#usage">Usage</a>
    -   <a href="#create-electron-app-multiple-projects">Create electron app from scratch (multiple projects, recommended)]</a>
    -   <a href="#create-electron-app-single-project">Create electron app from scratch (single project)</a>
    -   <a href="#reuse-angular-project">Reuse an existing Angluar project as renderer project</a>
-   <a href="#additional-topics">Additional topics</a>
    -   <a href="#webpack-externals">Webpack externals</a>
    -   <a href="#include-node-modules">Include node modules in the electron app package</a>
-   <a href="#app-schematic-options">App-schematic options</a>
-   <a href="#builder-options">Builder options</a>
    -   <a href="#builder-build">Builder: build</a>
    -   <a href="#builder-serve">Builder: serve</a>
...
<a name="create-electron-app-multiple-projects"></a>
...
<a name="create-electron-app-single-project"></a>
...
<a name="reuse-angular-project"></a>
...
<a name="app-schematic-options"></a>
